...
- Plan: confirm the active scaffold from `docs/STATUS.md`, `.ai/scaffolds/`, or the user request.
...
- Advance: update `docs/STATUS.md` only when implementation, tests, and review are complete.
